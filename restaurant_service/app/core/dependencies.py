...
async def get_creating_restaurant_handler(user_profile_repository = Depends(get_restaurant_repository)):
    return(
...
async def get_getting_all_restaurants_handler(user_profile_repository = Depends(get_restaurant_repository)):
    return(
